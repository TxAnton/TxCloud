...
namespace sStats {
    ...
    static TerrainType classToTerrain(CommonClass commonClass) {
        ...
        switch (commonClass) {
            case CommonClass::SpikyTerrain:
                return TerrainType::SpikyTerrain;
            case CommonClass::SteepTerrain:
                return TerrainType::SteepTerrain;
            case CommonClass::HollyTerrain:
                return TerrainType::HollyTerrain;
        }
    };
    ...
    static CommonClass unitToCommon(UnitClass unitClass) {
        switch (unitClass) {
            case UnitClass::TheRanger:
                return CommonClass::TheRanger;
            case UnitClass::ThePowerful:
                return CommonClass::ThePowerful;
            case UnitClass::TheAgile:
                return CommonClass::TheAgile;
            case UnitClass::TheMarathoner:
                return CommonClass::TheMarathoner;
            case UnitClass::TheTough:
                return CommonClass::TheTough;
            case UnitClass::TheVampire:
