...
DrawGraphicsView::DrawGraphicsView(QPixmap pixmap, QGraphicsView *parent) : QGraphicsView(parent) {
...
int DrawGraphicsView::updateImage(QPixmap pixmap) {
...
void DrawGraphicsView::mousePressEvent(QMouseEvent *event) {
    *pos = DrawGraphicsView::mapToScene(event->pos()).toPoint();
...
void DrawGraphicsView::clearGroup(QGraphicsItemGroup* group_) {
...
void DrawGraphicsView::sl_turn(Mode mode){
    qDebug() << "sl_turn" << mode ;
    //TO DO
}

void DrawGraphicsView::sl_turn_tri(bool isFill, QColor* line_color, QColor* fill_color, int line_width){
    mode = m_triangle;
    pc = 0;
    this->isFill = isFill;
...
void DrawGraphicsView::sl_turn_rot(int a){
...
void DrawGraphicsView::sl_turn_inv(){
    mode = m_invert;
}

void DrawGraphicsView::sl_turn_cut(){
    mode = m_cut;
}

void DrawGraphicsView::sl_turn_lin(int line_width,QColor* line_color){
    mode = m_line;
    pc = 0;
    this->line_color = line_color;
    this->line_width = line_width;
