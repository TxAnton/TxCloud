/****************************************************************************
** Meta object code from reading C++ file 'rot_dialog.h'
**
...
#error "The header file 'rot_dialog.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 10, 12), // "sig_turn_rot"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 9) // "sl_rot_ok"

    },
    "rotDialog\0sig_turn_rot\0\0sl_rot_ok"
};
...
void rotDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sig_turn_rot((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->sl_rot_ok(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (rotDialog::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&rotDialog::sig_turn_rot)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void rotDialog::sig_turn_rot(int _t1)
{
