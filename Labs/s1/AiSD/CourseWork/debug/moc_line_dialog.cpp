/****************************************************************************
** Meta object code from reading C++ file 'line_dialog.h'
**
...
#error "The header file 'line_dialog.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 11, 12), // "sig_turn_lin"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 7), // "QColor*"
QT_MOC_LITERAL(4, 33, 14), // "set_line_color"
QT_MOC_LITERAL(5, 48, 10) // "sl_line_ok"

    },
    "lineDialog\0sig_turn_lin\0\0QColor*\0"
    "set_line_color\0sl_line_ok"
};
...
void lineDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<lineDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sig_turn_lin((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QColor*(*)>(_a[2]))); break;
        case 1: _t->set_line_color(); break;
        case 2: _t->sl_line_ok(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (lineDialog::*)(int , QColor * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&lineDialog::sig_turn_lin)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject lineDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_lineDialog.data,
    qt_meta_data_lineDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void lineDialog::sig_turn_lin(int _t1, QColor * _t2)
{
